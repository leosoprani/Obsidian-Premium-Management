...
document.addEventListener('DOMContentLoaded', () => {
    ...
    window.app.handlers.saveGuestHandler = async (e) => {
        ...
        const guestData = {
            ...
            documents: modals.getGuestDocumentsState() || []
        };
        ...
        if (!token) {
            ...
            initialize(false, window.app.state.userRole).then(async () => {
                ...
                if (isAdminOrStaff) {
                    ...
                    if (!window.app.state.selectedApartment && window.app.state.properties.length > 0) {
                        window.app.state.selectedApartment = window.app.state.properties[0].name;
                    }
