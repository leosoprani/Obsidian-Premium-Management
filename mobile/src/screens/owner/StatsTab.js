...
function StatCard({ label, value, sub, icon, iconColor, activeTheme }) {
  return (
    <View style={[styles.statCard, { backgroundColor: activeTheme.colors.glass, borderColor: activeTheme.colors.glassBorder }]}>
...
export default function StatsTab({ selectedApartment, navigate }) {
        ...
        <SafeAreaView edges={['top']}>
            <View style={styles.headerContent}>
                ...
                <TouchableOpacity activeOpacity={0.7} style={styles.filterBtn}>
                    <View style={[styles.filterInner, { borderColor: activeTheme.colors.glassBorder }]}>
                        <Image 
      ...
      >
        ...
        <View style={styles.gridRow}>
          <StatCard 
            ...
            icon={require('../../../assets/icons/calendar_active.png')} 
        ...
        <View style={[styles.revenueBox, { backgroundColor: activeTheme.colors.glass, borderColor: activeTheme.colors.glassBorder }]}>
        ...
        <View style={styles.insightSection}>
            ...
            <View style={[styles.insightCard, { backgroundColor: activeTheme.colors.glass, borderColor: activeTheme.colors.glassBorder }]}>
                <LinearGradient
