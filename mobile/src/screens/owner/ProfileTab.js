          ...
          <View style={styles.headerContent}>
            ...
            >
              <Image
                ...
                tintColor={activeTheme.colors.error}
                resizeMode="contain"
              />
            </TouchableOpacity>
          </View>
          ...
          <View style={[styles.glassCard, { backgroundColor: activeTheme.colors.glass, borderColor: activeTheme.colors.glassBorder }]}>
            ...
            <View style={styles.infoRow}>
              <View style={styles.infoLabelPart}>
                ...
                <Text style={[styles.infoLabel, { color: activeTheme.colors.textSecondary }]}>Permissão</Text>
              </View>
          ...
          >
            ...
            >
              ...
              <Image
                ...
                tintColor={activeTheme.colors.text}
                resizeMode="contain"
              />
            </BlurView>
          </TouchableOpacity>
              ...
              <View style={[styles.actionBtn, { backgroundColor: activeTheme.colors.glass, borderColor: activeTheme.colors.glassBorder }]}>
                <View style={styles.actionBtnLeft}>
                  <LinearGradient colors={['#25d36630', '#25d36610']} style={styles.actionIcon}>
                    <Image source={require('../../../assets/icons/whatsapp_active.png')} style={{ width: 18, height: 18 }} tintColor="#25d366" resizeMode="contain" />
                  </LinearGradient>
                  <Text style={[styles.actionBtnText, { color: activeTheme.colors.text }]}>Resumo para WhatsApp</Text>
                </View>
                <Image source={require('../../../assets/icons/send_active.png')} style={{ width: 16, height: 16, opacity: 0.5 }} tintColor={activeTheme.colors.textSecondary} resizeMode="contain" />
              </View>
            </TouchableOpacity>
