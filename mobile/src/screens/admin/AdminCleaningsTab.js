...
export default function AdminCleaningsTab() {
  ...
  const renderItem = ({ item }) => (
    <View style={[styles.card, { backgroundColor: activeTheme.colors.surfaceVariant, borderColor: activeTheme.colors.border }]}>
      <View style={[styles.iconBox, { backgroundColor: `${activeTheme.colors.secondary}15` }]}>
        <Image source={require('../../assets/icons/cleaning_active.png')} style={{ width: 22, height: 22 }} resizeMode="contain" />
      </View>
      <TouchableOpacity 
      ...
      >
        ...
        <Text style={[styles.desc, { color: activeTheme.colors.text }]}>{item.notes?.replace('Prestador: ', '') || 'Limpeza Padrão'}</Text>
      ...
      <FlatList
        ...
        ListEmptyComponent={
          <View style={styles.empty}>
            <Image source={require('../../assets/icons/cleaning_inactive.png')} style={{ width: 48, height: 48, opacity: 0.5 }} resizeMode="contain" />
