        ...
        <BlurView intensity={80} tint="dark" style={styles.modalContent}>
          <View style={styles.modalHeader}>
            ...
            <TouchableOpacity onPress={onClose} style={styles.closeBtn}>
              <Image source={require('../../assets/icons/stop_active.png')} style={{ width: 20, height: 20, opacity: 0.5 }} resizeMode="contain" />
            </TouchableOpacity>
          </View>
            ...
            {isEdit && (
                ...
                >
                    {deleting ? (
                        ...
                        <>
                            <Image source={require('../../assets/icons/stop_active.png')} style={{ width: 18, height: 18 }} resizeMode="contain" />
