...
import {
  ...
  TouchableOpacity, ActivityIndicator, RefreshControl, Alert, Dimensions
} from 'react-native';
...
const getStatusConfig = (theme) => ({
  ...
  'finished':         { label: 'Finalizada', color: theme.colors.textTertiary, bg: theme.isDark ? 'rgba(100, 116, 139, 0.1)' : 'rgba(0,0,0,0.05)' },
...
function ReservationItem({ item, onAction }) {
  ...
  return (
    ...
    >
      <BlurView intensity={isDark ? 20 : 60} tint={isDark ? "dark" : "light"} style={[styles.resCard, { backgroundColor: activeTheme.colors.glass, borderColor: activeTheme.colors.border }]}>
          <View style={styles.resHeader}>
              <View style={{ flex: 1 }}>
                  <View style={[styles.aptBadge, { backgroundColor: `${activeTheme.colors.primary}15` }]}>
          ...
          {item.status === 'pending-approval' && (
              <View style={[styles.actionRow, { borderTopColor: activeTheme.colors.border }]}>
                  <TouchableOpacity 
                      activeOpacity={0.8}
                  ...
                  >
                      <Image source={require('../../assets/icons/stop_active.png')} style={{ width: 20, height: 20 }} resizeMode="contain" />
                  </TouchableOpacity>
              </View>
          )}
      </BlurView>
...
export default function AdminReservationsTab() {
  ...
  const FilterButton = ({ id, label, icon }) => {
    const isActive = activeFilter === id;
     return (
      ...
      >
        <Image source={isActive ? require('../../assets/icons/check_white.png') : require('../../assets/icons/dots_inactive.png')} style={{ width: 14, height: 14 }} resizeMode="contain" />
  ...
  return (
    <View style={[styles.container, { backgroundColor: activeTheme.colors.background }]}>
      <BlurView intensity={isDark ? 80 : 95} tint={isDark ? "dark" : "light"} style={[styles.floatingHeader, { borderBottomColor: activeTheme.colors.border }]}>
                     ...
                     <View style={{ flexDirection: 'row', alignItems: 'center', gap: 8 }}>
                      ...
                      {isOfflineData && (
                        <View style={[styles.offlineBadge, { backgroundColor: `${activeTheme.colors.warning}15` }]}>
                          <Image source={require('../../assets/icons/offline_active.png')} style={{ width: 10, height: 10 }} resizeMode="contain" />
      ...
      <FlatList
        ...
        ListHeaderComponent={
           <View style={[styles.topSection, { paddingTop: height * 0.25 }]}>
            <BlurView intensity={isDark ? 10 : 30} tint={isDark ? "dark" : "light"} style={[styles.searchBar, { borderColor: activeTheme.colors.border, backgroundColor: activeTheme.colors.glass }]}>
              <Image source={require('../../assets/icons/search_inactive.png')} style={{ width: 18, height: 18, marginRight: 12, opacity: 0.5 }} resizeMode="contain" />
              <TextInput 
              ...
              />
               {searchText ? (
                  <TouchableOpacity onPress={() => setSearchText('')}>
                      <Image source={require('../../assets/icons/stop_active.png')} style={{ width: 18, height: 18, opacity: 0.3 }} resizeMode="contain" />
                  </TouchableOpacity>
              ) : null}
            </BlurView>
          </View>
         ...
         ListEmptyComponent={
            <View style={styles.empty}>
                <View style={[styles.emptyIconWrap, { backgroundColor: activeTheme.colors.glass }]}>
                    <Image source={require('../../assets/icons/reservations_inactive.png')} style={{ width: 48, height: 48, opacity: 0.3 }} resizeMode="contain" />
                </View>
...
const styles = StyleSheet.create({
  ...
  filterLabel: { color: theme.colors.textTertiary, fontSize: 13, fontWeight: '600' },
  ...
  searchInput: { flex: 1, height: 50, color: '#fff', fontSize: 15, fontWeight: '600' },
  ...
  resGuest: { color: theme.colors.text, fontSize: 18, fontWeight: '800', letterSpacing: -0.5 },
