...
async function initTransporter() {
    if (process.env.SMTP_HOST && process.env.SMTP_PORT) {
        ...
        console.log(`Inicializando SMTP Real: ${process.env.SMTP_HOST}:${process.env.SMTP_PORT}`);
        ...
        console.log("Configurações de SMTP limitadas no .env. Inicializando Ethereal de teste (ISSO PODE SER LENTO)...");
        ...
        console.log(`Serviço Ethereal pronto em: ${testAccount.user}`);
    }
}
